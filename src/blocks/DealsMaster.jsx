...
export default function DealsMaster({header}) {
        ...
        <div className="dm_wrap">
            ...
            <div className="dm_inner">
                ...
                <div className="dm_section">
                    ...
                    <div className="dm_specs_wrap">
                        <div className="dm_specs_item"><img src="spec_1.jpg"/></div>
                        <div className="dm_specs_item"><img src="spec_2.jpg"/></div>
                        <div className="dm_specs_item"><img src="spec_3.jpg"/></div>
                    </div>
                </div>
                <div className="dm_section">
